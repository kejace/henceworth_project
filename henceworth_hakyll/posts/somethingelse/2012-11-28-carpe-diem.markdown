...
[^footnote]: so that was a section
...
Vivamus tempus odio nec magna faucibus sed hendrerit lorem tempor. [^1]
...
Integer augue justo, scelerisque et consectetur id, rhoncus eget enim.[^2]

[^2]: Some more footnotes
